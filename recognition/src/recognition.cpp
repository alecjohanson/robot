...
showHelp (char *filename)
{
  ...
  std::cout << "     -v:                     Show debug info." << std::endl;
...
parseCommandLine (int argc, char *argv[])
{
  ...
  //General parameters
  if (pcl::console::parse_argument (argc, argv, "--model_ss", model_ss_)!=-1) counter=counter+2;
  if (pcl::console::parse_argument (argc, argv, "--scene_ss", scene_ss_)!=-1) counter=counter+2;
  if (pcl::console::parse_argument (argc, argv, "--rf_rad", rf_rad_)!=-1) counter=counter+2;
  if (pcl::console::parse_argument (argc, argv, "--descr_rad", descr_rad_)!=-1) counter=counter+2;
  if (pcl::console::parse_argument (argc, argv, "--cg_size", cg_size_)!=-1) counter=counter+2;
  if (pcl::console::parse_argument (argc, argv, "--cg_thresh", cg_thresh_)!=-1) counter=counter+2;
  if (verbose_) std::cout<<"counter: "<<counter;
  return counter;
}
...
modelExists(string model_filename_, pcl::PointCloud<PointType>::Ptr &scene)
{
  ...
  //   return (-1);
  // }
  if(verbose_)  std::cout<<"Loaded scene\n";
  ...
  //  Compute Normals
  //
  if(verbose_)  std::cout<<"Computing normals...";
  ...
  if(verbose_)  std::cout<<"Done!\n";
  //
  //  Downsample Clouds to Extract keypoints
  //
  pcl::PointCloud<int> sampled_indices;

  if(verbose_)  std::cout<<"Getting keypoints for model ...\n";
  pcl::UniformSampling<PointType> uniform_sampling;
  uniform_sampling.setInputCloud (model);
  uniform_sampling.setRadiusSearch (model_ss_);
  uniform_sampling.compute (sampled_indices);
  pcl::copyPointCloud (*model, sampled_indices.points, *model_keypoints);
  if(verbose_)  std::cout << "Model total points: " << model->size () << "; Selected Keypoints: " << model_keypoints->size () << std::endl;
  
  if(verbose_)  std::cout<<"Getting keypoints for scene...\n";
  uniform_sampling.setInputCloud (scene);
  uniform_sampling.setRadiusSearch (scene_ss_);
  uniform_sampling.compute (sampled_indices);
  pcl::copyPointCloud (*scene, sampled_indices.points, *scene_keypoints);
  if(verbose_)  std::cout << "Scene total points: " << scene->size () << "; Selected Keypoints: " << scene_keypoints->size () << std::endl;


  //
  //  Compute Descriptor for keypoints
  //
  if(verbose_)  std::cout<<"Computing SHOT descriptors...";
  ...
  //
  if(verbose_)  std::cout<<"Searching for correspondences in the scene... \n";
  ...
  if(verbose_)  std::cout << "Correspondences found: " << model_scene_corrs->size () << std::endl;
  if(verbose_)  std::cout<<"Done!\n";
  //
  //  Actual Clustering
  //
  ...
  if(verbose_)  std::cout<<"Clustering the correspondences ....";
  //  Using Hough3D
  if (use_hough_)
  {
    //
  ...
  //  Visualization
  //
  std::cout<<"Visualization started\n";
