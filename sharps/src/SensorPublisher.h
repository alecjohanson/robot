...
const double Sharp2Wheel_RearRightD = 6.14; //6.35;   // distance from sharp ch4 to wheel
...
const double Sharp2Edge_RearD = 3;           // distance from sharp ch2 to edge
const double Sharp2Edge_FrontD = 0;          // sharp ch3 to edge
