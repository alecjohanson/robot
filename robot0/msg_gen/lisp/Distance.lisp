...
(cl:defmethod cl:initialize-instance :after ((m <Distance>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Distance)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name robot0-msg:<Distance> is deprecated: use robot0-msg:Distance instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <Distance>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robot0-msg:header-val is deprecated.  Use robot0-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'rear-val :lambda-list '(m))
(cl:defmethod rear-val ((m <Distance>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robot0-msg:rear-val is deprecated.  Use robot0-msg:rear instead.")
  (rear m))

(cl:ensure-generic-function 'front-val :lambda-list '(m))
(cl:defmethod front-val ((m <Distance>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robot0-msg:front-val is deprecated.  Use robot0-msg:front instead.")
  (front m))

(cl:ensure-generic-function 'rear_r-val :lambda-list '(m))
(cl:defmethod rear_r-val ((m <Distance>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robot0-msg:rear_r-val is deprecated.  Use robot0-msg:rear_r instead.")
  (rear_r m))

(cl:ensure-generic-function 'front_r-val :lambda-list '(m))
(cl:defmethod front_r-val ((m <Distance>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robot0-msg:front_r-val is deprecated.  Use robot0-msg:front_r instead.")
  (front_r m))

(cl:ensure-generic-function 'rear_l-val :lambda-list '(m))
(cl:defmethod rear_l-val ((m <Distance>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robot0-msg:rear_l-val is deprecated.  Use robot0-msg:rear_l instead.")
  (rear_l m))

(cl:ensure-generic-function 'front_l-val :lambda-list '(m))
(cl:defmethod front_l-val ((m <Distance>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robot0-msg:front_l-val is deprecated.  Use robot0-msg:front_l instead.")
  (front_l m))
